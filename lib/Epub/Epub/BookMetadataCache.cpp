...
bool BookMetadataCache::buildBookBin(const std::string& epubPath, const BookMetadata& metadata,
  ...
  // Reuse the same unpackedPackage branch that the rest of Epub already uses
  // for reading file contents (see Epub::readItemContentsToBytes / getItemSize).
  if (!unpackedPackage) {
    ...
    // See: https://github.com/inkmod-reader/inkmod-reader/issues/134
