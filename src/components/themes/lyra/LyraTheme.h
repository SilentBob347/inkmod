...
constexpr ThemeMetrics values = {
  ...
  .headerHeight = 84,
  .verticalSpacing = 16,
  .contentSidePadding = 12,  // Уменьшено с 20 для большего пространства
  .listRowHeight = 36,
  .listWithSubtitleRowHeight = 60,
  .menuRowHeight = 56,
  .menuSpacing = 6,
  .tabSpacing = 6,  // Уменьшено с 8
  .tabBarHeight = 40,
  .scrollBarWidth = 4,
...
class LyraTheme : public BaseTheme {
 public:
  ...
  void drawButtonHints(GfxRenderer& renderer, const char* btn1, const char* btn2, const char* btn3, const char* btn4,
                       bool allowInvertedText = false, bool forceOnTouch = false) const override;
