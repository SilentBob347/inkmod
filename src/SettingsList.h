...
inline std::vector<SettingInfo> getSettingsList(const SdCardFontRegistry* registry = nullptr) {
  static const std::vector<SettingInfo> baseList = [] {
    ...
    add(SettingInfo::Enum(StrId::STR_UI_TEXT_SIZE, &InkMODSettings::uiTextSize,
                          {StrId::STR_STATE_OFF, StrId::STR_LARGE}, "uiTextSize", StrId::STR_CAT_DISPLAY)
            .withEnumRawValues(
    ...
    add(SettingInfo::Enum(
            ...
            .withEnumRawValues(
                {InkMODSettings::LONG_MENU_OFF, InkMODSettings::LONG_MENU_SLEEP,
                 ...
                 InkMODSettings::LONG_MENU_SYNC_PROGRESS, InkMODSettings::LONG_MENU_FILE_TRANSFER,
