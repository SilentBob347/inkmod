...
enum class Result {
  ...
  TOO_LARGE,
  BAD_MAGIC,
  INCOMPATIBLE_CHIP,  // ESP image chip_id at offset 0x0C differs from the running firmware
...
// header magic, chip-family compatibility (ESP image uint16_t chip_id at offset 0x0C),
