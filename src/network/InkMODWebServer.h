...
class InkMODWebServer {
 ...
 private:
  ...
  void handleUpload(UploadState& state, bool preparedBookCache = false, bool preparedFb2Package = false,
                    bool preparedWrappedEpub = false) const;
