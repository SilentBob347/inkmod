...
const uint8_t progressBarRawValues[PROGRESS_BAR_ITEMS] = {
    InkMODSettings::STATUS_BAR_PROGRESS_BAR::HIDE_PROGRESS,
    InkMODSettings::STATUS_BAR_PROGRESS_BAR::BOOK_PROGRESS,
    InkMODSettings::STATUS_BAR_PROGRESS_BAR::CHAPTER_PROGRESS,
};
...
const uint8_t titleRawValues[TITLE_ITEMS] = {
    InkMODSettings::STATUS_BAR_TITLE::HIDE_TITLE,
    InkMODSettings::STATUS_BAR_TITLE::BOOK_TITLE,
    InkMODSettings::STATUS_BAR_TITLE::CHAPTER_TITLE,
};
...
void StatusBarSettingsActivity::onEnter() {
  ...
  if (SETTINGS.statusBarProgressBarThickness >= PROGRESS_BAR_THICKNESS_ITEMS) {
    SETTINGS.statusBarProgressBarThickness = InkMODSettings::STATUS_BAR_PROGRESS_BAR_THICKNESS::PROGRESS_BAR_NORMAL;
  }
  ...
  if (SETTINGS.xtcStatusBarMode >= XTC_STATUS_BAR_ITEMS) {
    SETTINGS.xtcStatusBarMode = InkMODSettings::XTC_STATUS_BAR_MODE::XTC_STATUS_BAR_HIDE;
  }
...
void StatusBarSettingsActivity::render(RenderLock&&) {
  ...
  std::string title;
  if (SETTINGS.statusBarTitle == InkMODSettings::STATUS_BAR_TITLE::BOOK_TITLE) {
