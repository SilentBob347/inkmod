...
void ButtonRemapActivity::loop() {
  ...
  if (mappedInput.wasPressed(MappedInputManager::Button::Up)) {
    ...
    if (readerMode) {
      ...
      SETTINGS.readerFrontButtonBack = InkMODSettings::FRONT_HW_BACK;
      SETTINGS.readerFrontButtonConfirm = InkMODSettings::FRONT_HW_CONFIRM;
      SETTINGS.readerFrontButtonLeft = InkMODSettings::FRONT_HW_LEFT;
      SETTINGS.readerFrontButtonRight = InkMODSettings::FRONT_HW_RIGHT;
    } else {
...
void ButtonRemapActivity::render(RenderLock&&) {
  ...
  GUI.drawButtonHints(renderer, labelForHardware(InkMODSettings::FRONT_HW_BACK),
                      labelForHardware(InkMODSettings::FRONT_HW_CONFIRM),
                      labelForHardware(InkMODSettings::FRONT_HW_LEFT),
                      labelForHardware(InkMODSettings::FRONT_HW_RIGHT));
...
const char* ButtonRemapActivity::getHardwareName(const uint8_t buttonIndex) const {
  switch (buttonIndex) {
    case InkMODSettings::FRONT_HW_BACK:
      return tr(STR_HW_BACK_LABEL);
    case InkMODSettings::FRONT_HW_CONFIRM:
      return tr(STR_HW_CONFIRM_LABEL);
    case InkMODSettings::FRONT_HW_LEFT:
      return tr(STR_HW_LEFT_LABEL);
    case InkMODSettings::FRONT_HW_RIGHT:
